...
#'
#' @param x An object of class \code{getgamma1bin}.
...
plot.getgamma1bin <- function(x,
  ...
  # --- Input validation ---
  if (!inherits(x, "getgamma1bin")) {
    stop("'x' must be an object of class 'getgamma1bin'")
  }
