#' Cumulative distribution function (CDF) of the difference between two beta variables
#'
#' This function calculates CDF(s) of difference between two beta variables
...
#'
#' @return The \code{pBetadiff} gives the numeric value of the density.
#'
#' @examples
