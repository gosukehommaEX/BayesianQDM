...
#' getJointBinary(pi1 = 0.3, pi2 = 0.4, rho = 0.0)
#'
#' # Example 2: Positive correlation
#' getJointBinary(pi1 = 0.3, pi2 = 0.4, rho = 0.3)
#'
#' # Example 3: Negative correlation
#' getJointBinary(pi1 = 0.3, pi2 = 0.4, rho = -0.2)
#'
#' # Example 4: Verify cell probabilities sum to 1
#' p <- getJointBinary(pi1 = 0.25, pi2 = 0.35, rho = 0.1)
#' sum(p)  # Should be 1
#'
...
#'
#' @export
getJointBinary <- function(pi1, pi2, rho, tol = 1e-10) {
