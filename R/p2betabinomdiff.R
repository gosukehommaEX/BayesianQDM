...
#'
#' The probability mass function for BetaBinomial(m, alpha, beta) is:
#' P(Y = k) = choose(m, k) * B(k + alpha, m - k + beta) / B(alpha, beta)
#'
...
#' requires evaluating (m1 + 1) times (m2 + 1) combinations.
#'
#' @examples
