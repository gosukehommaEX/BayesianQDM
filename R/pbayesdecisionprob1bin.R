...
#' @param gamma_go A numeric scalar in \code{(0, 1)} giving the minimum posterior/predictive
#'        probability required for a Go decision. Typically 0.8 or higher.
#' @param gamma_nogo A numeric scalar in \code{(0, 1)} giving the maximum posterior/predictive
#'        probability that triggers a NoGo decision. Must satisfy \code{gamma_nogo < gamma_go}.
