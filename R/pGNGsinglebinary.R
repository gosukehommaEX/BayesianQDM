...
#' }
#' The returned object has S3 class \code{pGNGsinglebinary} with an associated
#' \code{print} method.
#'
#' @details
...
#'         evaluated.
#'   \item For each pair, \code{\link{pPPsinglebinary}} computes the posterior or predictive
