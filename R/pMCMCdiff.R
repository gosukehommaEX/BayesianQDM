...
#' @param mu.n1 A numeric value representing the mean value of the treatment group in current trial.
#' @param mu.n2 A numeric value representing the mean value of the control group in current trial.
#' @param sd.n1 A positive numeric value representing the standard deviation of the treatment group in current trial.
#' @param sd.n2 A positive numeric value representing the standard deviation of the control group in current trial.
...
#'
#' @return A numeric value representing P(μt - μc > q), the posterior probability
...
#' @examples
#' \dontrun{
#' # Standard Bayesian analysis without external data
#' pMCMCdiff(nMCMCsample = 1e+4, q = 4, mu.n1 = 5, mu.n2 = 0, sd.n1 = 1, sd.n2 = 1,
#'           n1 = 12, n2 = 12, ne1 = NULL, ne2 = NULL, alpha01 = NULL, alpha02 = NULL)
#'
#' # With external control data using power prior
#' pMCMCdiff(nMCMCsample = 1e+4, q = 4, mu.n1 = 5, mu.n2 = 0, sd.n1 = 1, sd.n2 = 1,
#'           n1 = 12, n2 = 12, ne1 = NULL, ne2 = 24, alpha01 = NULL, alpha02 = 0.5)
#'
#' # With external treatment data using power prior
#' pMCMCdiff(nMCMCsample = 1e+4, q = 4, mu.n1 = 5, mu.n2 = 0, sd.n1 = 1, sd.n2 = 1,
#'           n1 = 12, n2 = 12, ne1 = 24, ne2 = NULL, alpha01 = 0.5, alpha02 = NULL)
#'
#' # With both external treatment and control data
#' pMCMCdiff(nMCMCsample = 1e+4, q = 4, mu.n1 = 5, mu.n2 = 0, sd.n1 = 1, sd.n2 = 1,
...
pMCMCdiff <- function(nMCMCsample, q, mu.n1, mu.n2, sd.n1, sd.n2, n1, n2, ne1, ne2, alpha01, alpha02) {
  ...
  if(has_external_treatment & has_external_control) {
    ...
    if(!is.null(alpha01) & !is.null(alpha02) & alpha01 == 0 & alpha02 == 0) {
      ...
      bdp_args$mu0_t <- mu.n1
      bdp_args$sigma0_t <- sd.n1
      bdp_args$N0_t <- ne1
      bdp_args$mu0_c <- mu.n2
      bdp_args$sigma0_c <- sd.n2
      bdp_args$N0_c <- ne2
