...
#' @param y2 A non-negative integer representing the observed number of responders
...
pPPsinglebinary <- function(prob = 'posterior', design = 'controlled', theta0,
  ...
  # Calculate posterior shape parameters for group 1
  ...
  # Calculate posterior shape parameters for group 2
  # Incorporate external data if design is 'external'
