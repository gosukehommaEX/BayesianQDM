...
#'     mu01 = 5, mu02 = 5, sigma01 = sqrt(5), sigma02 = sqrt(5), bar.y1 = 2, bar.y2 = 0, s1 = 1, s2 = 1, r = NULL
#'   )
#' })
#' sapply(c(2, 0), function(theta0) {
#'   BayesPostPredContinuous(
...
#'   mu01 = NULL, mu02 = 0, sigma01 = NULL, sigma02 = NULL, bar.y1 = 2, bar.y2 = NULL, s1 = 1, s2 = NULL, r = 12
#' )
#' BayesPostPredContinuous(
