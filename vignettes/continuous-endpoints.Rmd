...
- **MC**: Use when other methods fail or for sensitivity analysis
...
- **γ₁ (Go threshold)**: 0.8-0.9 for high confidence
- **γ₂ (NoGo threshold)**: 0.2-0.3 for early stopping

#### Prior Selection

- **Vague priors**: When minimal prior information is available
- **Conjugate priors**: For incorporating historical data or expert opinion
...
2. **Comparison of calculation methods** (NI vs WS)
3. **Go/NoGo/Gray decision framework** with operating characteristics
4. **Prior specification** (vague vs informative)
5. **External control design** using power priors
6. **Power analysis** for sample size determination

The BayesianQDM package for continuous endpoints provides:

- Multiple calculation methods for different accuracy-speed trade-offs
- Flexible prior specifications for incorporating existing knowledge
