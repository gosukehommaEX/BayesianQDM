...
```{r method_comparison, fig.width=10, fig.height=6, fig.alt="Comparison of numerical integration vs Welch-Satterthwaite methods showing posterior probabilities across different effect sizes and thresholds"}
...
```{r oc_visualization, fig.width=10, fig.height=6, fig.alt="Operating characteristics showing Go, Gray, and NoGo decision probabilities across different true treatment effects and sample sizes"}
